...
class IODebug:
    ...
    # setOutputs
    @staticmethod
    def Configure(Out_normal, Out_error, verbose, more_verbose, path_output):
        '''
        Configure debugging 
        ...
        IODebug._more_debug = more_verbose
        IODebug._debug = verbose
        if IODebug._more_debug:
            IODebug._debug = IODebug._more_debug
    ...
    # displayInfo
    @staticmethod
    def displayInfo(text, indentation = 0):
        '''
    ...
    # displayInfo
    @staticmethod
    def displayError(text, indentation = 0):
        '''
        This function display informational info
    ...
    # displayInfo
    @staticmethod
    def displayDebugInfo(text, indentation = 0):
        '''
        ...
        @return: None
        '''
        if text is not None and IODebug._debug and IODebug.isConfigured():
            m_text = "%s%s\n" % (" " * indentation, text)
            IODebug._normal_output.write(m_text)
            if IODebug._fileOut != None:
                IODebug._fileOut.write(m_text)            
    ...
    # displayInfo
    @staticmethod
    def displayDebugError(text, indentation = 0):
        '''
        This function display informational info, only if debug is enabled.
    ...
    @staticmethod
    def displayMoreDebugInfo(text, indentation = 0):
        '''
        This function display informational info, only if debug is enabled.
        ...
        @return: None
        '''
        if text is not None and IODebug._more_debug and IODebug.isConfigured():
            m_text = "%s%s\n" % (" " * indentation, text)
            IODebug._normal_output.write(m_text)
            if IODebug._fileOut != None:
                IODebug._fileOut.write(m_text)            
    ...
    @staticmethod
    def displayMoreDebugError(text, indentation = 0):
        '''
        This function display informational info, only if debug is enabled.
